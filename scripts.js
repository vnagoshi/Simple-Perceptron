...
function graphWeight() {
  ...
  let yOrigin = 500/2
  ctx.strokeStyle= "#00f"
  ctx.moveTo(xOrigin + (bias/5*250), yOrigin);
  ctx.lineTo(weightVector.x / xMax * 500 / 2 + xOrigin + (bias/5*250), weightVector.y / yMax * 500 / -2 + yOrigin);
  ctx.stroke();
  ctx.strokeStyle= "#000"
  let temp;
}
...
function graphPerpendicularWeight() {
  ...
  ctx.lineTo(xPerp / xMax * 5000 / 2 + xOrigin  + (bias/5*250), yPerp / yMax * 5000 / -2 + yOrigin);
  if(weightVector.x !=0){    
    ctx.lineTo(-xPerp / xMax * 5000 / 2 + xOrigin + (bias/5*250), -yPerp / yMax * 5000 / -2 + yOrigin);
  }else{
    ctx.lineTo(-xPerp / xMax * 5000 / 2 + xOrigin + (bias/5*250), yPerp / yMax * 5000 / -2 + yOrigin);
